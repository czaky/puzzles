...
class TestUnsortedArray(unittest.TestCase):
    ...
    def test_duplicates(self):
        ...
        assert ar.duplicates([1, 3, 5, 2, 2]) == [2]
        assert ar.duplicates([2, 3, 2, 1, 2, 1, 3]) == [1, 2, 3]
    ...
    def test_product_except_self(self):
        ...
        assert ar.product_except_self([10, 3, 5, 0, 6, 2]) == [0, 0, 0, 1800, 0, 0]
        assert ar.product_except_self([10, 3, 5, 6, 2]) == [180, 600, 360, 300, 900]
    ...
    def test_window_distinct_count(self):
        ...
        assert ar.window_distinct_count([10, 3, 5, 0, 6, 2], 5) == [5, 5]
        assert ar.window_distinct_count([10, 3, 5, 6, 2], 2) == [2, 2, 2, 2]
        assert ar.window_distinct_count([1, 2, 1, 3, 4, 2, 3], 4) == [3, 4, 4, 3]

    def test_pascal_triangle_row(self):
        """Test `test_pascal_triangle_row` function."""
        assert ar.pascal_triangle_row(1) == [1]
        assert ar.pascal_triangle_row(2) == [1, 1]
        assert ar.pascal_triangle_row(3) == [1, 2, 1]
        assert ar.pascal_triangle_row(4) == [1, 3, 3, 1]
    ...
    def test_merge_sorted(self):
        ...
        ar.merge_sorted(a, b)
        assert a == [0, 4, 5, 6, 7]
        assert b == [8, 12, 12, 13, 13, 15]
        a, b = b, a
        ar.merge_sorted(a, b)
        assert a == [0, 4, 5, 6, 7, 8]
        assert b == [12, 12, 13, 13, 15]
    ...
    def test_next_smallest_palindrome(self):
        ...
        assert ar.next_smallest_palindrome_number([0]) == [1]
        assert ar.next_smallest_palindrome_number([7]) == [8]
        assert ar.next_smallest_palindrome_number([9]) == [1, 1]
        assert ar.next_smallest_palindrome_number([6, 1]) == [6, 6]
        assert ar.next_smallest_palindrome_number([9, 9]) == [1, 0, 1]
        assert ar.next_smallest_palindrome_number([2, 3, 4, 5]) == [2, 4, 4, 2]
        assert ar.next_smallest_palindrome_number([2, 3, 5, 4, 5]) == [2, 3, 6, 3, 2]
    ...
    def test_smaller_on_right_counts(self):
        ...
        assert ar.smaller_on_right_counts(
            [12, 1, 2, 3, 0, 11, 4]
        ) == [6, 1, 1, 1, 0, 1, 0]
        assert ar.smaller_on_right_counts([1, 2, 3, 4]) == [0, 0, 0, 0]
        assert ar.smaller_on_right_counts([1, 2, 3, 4, 5]) == [0, 0, 0, 0, 0]

        assert ar.smaller_on_right_counts([4, 3, 2, 1]) == [3, 2, 1, 0]
        assert ar.smaller_on_right_counts([5, 4, 3, 2, 1]) == [4, 3, 2, 1, 0]
